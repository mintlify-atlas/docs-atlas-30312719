...
description: "Every A.D.A.M. reply must start with a MODE tag, append an AUDIT block when warranted, and fail-closed to ADAM_UNSUPPORTED if strict invariants cannot be met."
---
