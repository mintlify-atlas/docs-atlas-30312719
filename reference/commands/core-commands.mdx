...
description: "All five A.D.A.M. core commands with exact output contracts: ADAM PING, ADAM REMOUNT, ADAM PERSIST, ADAM OFF, and ADAM ON, plus command matching rules."
---
